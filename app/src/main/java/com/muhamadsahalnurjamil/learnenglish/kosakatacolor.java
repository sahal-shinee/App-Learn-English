...
public class kosakatacolor extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kosakatacolor);
        ...
        btnback.setOnClickListener(v -> {
            startActivity(new Intent(kosakatacolor.this, menukosakata.class));
            finish();
        });
        ...
        suara1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                mp = MediaPlayer.create(kosakatacolor.this, R.raw.red);
                mp.start();
            }
        });
        ...
        suara2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                mp = MediaPlayer.create(kosakatacolor.this, R.raw.blue);
                mp.start();
            }
        });
        ...
        suara3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                mp = MediaPlayer.create(kosakatacolor.this, R.raw.yellow);
                mp.start();
            }
        });
        ...
        suara4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                mp = MediaPlayer.create(kosakatacolor.this, R.raw.green);
                mp.start();
            }
        });
        ...
        suara5.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                mp = MediaPlayer.create(kosakatacolor.this, R.raw.grey);
                mp.start();
            }
        });
