...
public class kosakatafamily extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kosakatafamily);
        ...
        btnback.setOnClickListener(v -> {
            startActivity(new Intent(kosakatafamily.this, menukosakata.class));
            finish();
        });
        ...
        suara1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                mp = MediaPlayer.create(kosakatafamily.this, R.raw.father);
                mp.start();
            }
        });
        ...
        suara2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                mp = MediaPlayer.create(kosakatafamily.this, R.raw.mother);
                mp.start();
            }
        });
        ...
        suara3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                mp = MediaPlayer.create(kosakatafamily.this, R.raw.grandfather);
                mp.start();
            }
        });
        ...
        suara4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                mp = MediaPlayer.create(kosakatafamily.this, R.raw.grandmother);
                mp.start();
            }
        });
        ...
        suara5.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                mp = MediaPlayer.create(kosakatafamily.this, R.raw.uncle);
                mp.start();
            }
        });
    }
