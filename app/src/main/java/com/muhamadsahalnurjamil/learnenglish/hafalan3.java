...
public class hafalan3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hafalan3);
        ...
        btnback.setOnClickListener(v -> {
            startActivity(new Intent(hafalan3.this, menuhafalan.class));
            finish();
        });
        ...
        suara1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                mp = MediaPlayer.create(hafalan3.this, R.raw.howmuch);
                mp.start();
            }
        });
        ...
        suara2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                mp = MediaPlayer.create(hafalan3.this, R.raw.wherebethroom);
                mp.start();
            }
        });
        ...
        suara3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                mp = MediaPlayer.create(hafalan3.this, R.raw.whattime);
                mp.start();
            }
        });
        ...
        suara4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                mp = MediaPlayer.create(hafalan3.this, R.raw.seeyou);
                mp.start();
            }
        });
        ...
        suara5.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                mp = MediaPlayer.create(hafalan3.this, R.raw.name);
                mp.start();
            }
        });
    }
