...
public class hafalan4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hafalan4);
        ...
        btnback.setOnClickListener(v -> {
            startActivity(new Intent(hafalan4.this, menuhafalan.class));
            finish();
        });
        ...
        suara1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                mp = MediaPlayer.create(hafalan4.this, R.raw.myname);
                mp.start();
            }
        });
        ...
        suara2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                mp = MediaPlayer.create(hafalan4.this, R.raw.wherefrom);
                mp.start();
            }
        });
        ...
        suara3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                mp = MediaPlayer.create(hafalan4.this, R.raw.imfrom);
                mp.start();
            }
        });
        ...
        suara4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                mp = MediaPlayer.create(hafalan4.this, R.raw.old);
                mp.start();
            }
        });
        ...
        suara5.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                mp = MediaPlayer.create(hafalan4.this, R.raw.question);
                mp.start();
            }
        });
    }
