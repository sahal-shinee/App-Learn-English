...
public class hafalan5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hafalan5);
        ...
        btnback.setOnClickListener(v -> {
            startActivity(new Intent(hafalan5.this, menuhafalan.class));
            finish();
        });
        ...
        suara1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                mp = MediaPlayer.create(hafalan5.this, R.raw.worry);
                mp.start();
            }
        });
        ...
        suara2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                mp = MediaPlayer.create(hafalan5.this, R.raw.idea);
                mp.start();
            }
        });
        ...
        suara3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                mp = MediaPlayer.create(hafalan5.this, R.raw.agree);
                mp.start();
            }
        });
        ...
        suara4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                mp = MediaPlayer.create(hafalan5.this, R.raw.dontknow);
                mp.start();
            }
        });
        ...
        suara5.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                mp = MediaPlayer.create(hafalan5.this, R.raw.niceday);
                mp.start();
            }
        });
    }
